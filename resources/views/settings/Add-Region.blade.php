    ...
    <div class="row m-1">
        <div class="col-12 ">
            ...
            <ul class="app-line-breadcrumbs mb-3">
                ...
                <li class="active">
                    <a class="f-s-14 f-w-500" href="#">Add Region</a>
                </li>
            </ul>
        </div>
    </div>
     ...
     <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="app-form">
                        <form class="row g-3 app-form" enctype="multipart/form-data" action="{{ route('add-region-process') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <button class="btn btn-primary" type="submit">Add Region
                                    </button>
                                </div>
                                <div class="col-6">

    ...
    <div class="row m-1">
        <div class="col-12 ">
            ...
            <ul class="app-line-breadcrumbs mb-3">
                ...
                <li class="active">
                    <a class="f-s-14 f-w-500" href="#">Add Attachment</a>
                </li>
            </ul>
        </div>
    </div>
     ...
     <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="app-form">
                        <form class="row g-3 app-form" enctype="multipart/form-data" action="{{ route('add-attachment-process') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <select class="form-control b-r-right" name="status">
                                        ...
                                        <button class="btn btn-primary" type="submit"  >Add Attachment
                                        </button>

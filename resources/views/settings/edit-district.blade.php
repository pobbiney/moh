    ...
    <div class="row m-1">
        <div class="col-12 ">
            ...
            <ul class="app-line-breadcrumbs mb-3">
                ...
                <li class="active">
                    <a class="f-s-14 f-w-500" href="#">Edit District</a>
                </li>
            </ul>
        </div>
    </div>
     ...
     <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="app-form">
                        <form class="row g-3 app-form" enctype="multipart/form-data" action="{{ route('edit-district-process',$id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group mb-3">
                                       <select class="form-control" name="region">
                                        ...
                                        <option @if($lists->id==$data->region_id) selected @endif value="{{ $lists->id }}">{{ $lists->name }}</option>
                                        @endforeach
                                       </select> 
                                    </div>
                                    ...
                                    <button class="btn btn-primary" type="submit">Update District
                                    </button>
                                </div>
                                <div class="col-6">
        ...
        if(confirm('Are you sure?')) {
            $.ajax({
                ...
                success: function(response) {
                    // Remove the element or refresh page
                    location.reload();
                }
            });
        }

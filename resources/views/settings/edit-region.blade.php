    ...
    <div class="row m-1">
        <div class="col-12 ">
            ...
            <ul class="app-line-breadcrumbs mb-3">
                ...
                <li class="active">
                    <a class="f-s-14 f-w-500" href="#">Edit Region</a>
                </li>
            </ul>
        </div>
    </div>
     ...
     <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="app-form">
                        <form class="row g-3 app-form" enctype="multipart/form-data" action="{{ route('edit-region-process',$id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input aria-describedby="basic-addon1" aria-label="Name"
                                            class="form-control b-r-right" placeholder="Region Name"
                                    ...
                                    <button class="btn btn-primary" type="submit">Edit Region
                                    </button>
                                </div>
                                <div class="col-6">
                                            ...
                                            <tbody>
                                                  ...
                                                  @foreach($list as $lists)
                                                    <tr>
                                                        ...
                                                        <td>{{ $lists->name }}</td>
                                                        <td>{{ $lists->status }}</td>
                                                        <td> <a href="{{route('edit-region',Crypt::encrypt($lists->id))}}" class="btn btn-sm btn-success" data-bs-custom-class="custom-success"
                                                            data-bs-html="true"
